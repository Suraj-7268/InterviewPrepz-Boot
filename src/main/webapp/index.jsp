					...
					<div class="col-lg-5 col-md-6 col-md-offset-1 section-left">
						<div class="article">
							<div class="wrap">
								...
								<div class="heading">
									<h5><span class="fa fa-desktop"></span>Comprehensive, Updated Content</h5>
					...
					<div class="col-lg-5 col-md-6 col-md-offset-6 section-right">
						<div class="article">
							<div class="wrap">
								...
								<div class="heading">
									<h5><span class="fa fa-credit-card"></span>Adaptive learning</h5>
					...
					<div class="col-lg-5 col-md-6 col-md-offset-1 section-left">
						<div class="article">
							<div class="wrap">
								...
								<div class="heading">
									<h5><span class="fa fa-credit-card"></span> Personalized Feedback</h5>
